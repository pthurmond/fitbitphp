...
class FitBitPHP
{
  ...
  /**
   * @param      $apiHost   API host, i.e. api.fitbit.com (do you know any others?)
   * @param      $authHost  Auth host, i.e. www.fitbit.com
   * @param bool $https
   * @param bool $httpsApi
   */
   ...
   *
   * @param  string  $callbackUrl  Callback for 'Sign in with Fitbit'
   * @param  bool    $cookie       Use persistent cookie for authorization, or session cookie only
   *
  ...
  public function getProfile()
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/" . $this->userId . "/profile." . $this->responseFormat,
        null,
    ...
    if (!strcmp($responseInfo['http_code'], '200')) {
      ...
      if ($response) {
        ...
        throw new FitBitException(
          ...
          'Fitbit request failed. Code: ' . $responseInfo['http_code']
        );
      }
    }
    else {
  ...
  public function updateProfile(
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/profile." . $this->responseFormat,
        $parameters,
  ...
  public function getActivities($date, $dateStr = null)
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/" . $this->userId . "/activities/date/" . $dateStr . "." . $this->responseFormat,
        null,
        OAUTH_HTTP_METHOD_GET,
        $headers
      );
  ...
  public function getRecentActivities()
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/activities/recent." . $this->responseFormat,
        null,
        OAUTH_HTTP_METHOD_GET,
        $headers
      );
  ...
  public function getFrequentActivities()
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/activities/frequent." . $this->responseFormat,
        null,
        OAUTH_HTTP_METHOD_GET,
        $headers
      );
  ...
  public function getFavoriteActivities()
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/activities/favorite." . $this->responseFormat,
        null,
        OAUTH_HTTP_METHOD_GET,
        $headers
      );
   ...
   * Log user activity
   *
   * @param DateTime $date            Activity date and time (set proper timezone, which could be fetched via
   *                                  getProfile)
  ...
  public function logActivity(
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/activities." . $this->responseFormat,
        $parameters,
        OAUTH_HTTP_METHOD_POST,
        $headers
      );
  ...
  public function deleteActivity($id)
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/activities/" . $id . ".xml",
        null,
  ...
  public function addFavoriteActivity($id)
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/activities/log/favorite/" . $id . "." . $this->responseFormat,
        null,
        OAUTH_HTTP_METHOD_POST,
        $headers
      );
  ...
  public function deleteFavoriteActivity($id)
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/activities/log/favorite/" . $id . ".xml",
        null,
        OAUTH_HTTP_METHOD_DELETE,
        $headers
      );
  ...
  public function getActivity($id)
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "activities/" . $id . "." . $this->responseFormat,
        null,
        OAUTH_HTTP_METHOD_GET,
        $headers
      );
  ...
  public function browseActivities()
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "activities." . $this->responseFormat,
        null,
        OAUTH_HTTP_METHOD_GET,
        $headers
      );
  ...
  public function getFoods($date, $dateStr = null)
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/" . $this->userId . "/foods/log/date/" . $dateStr . "." . $this->responseFormat,
        null,
        OAUTH_HTTP_METHOD_GET,
        $headers
      );
  ...
  public function getRecentFoods()
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/foods/log/recent." . $this->responseFormat,
        null,
        OAUTH_HTTP_METHOD_GET,
        $headers
      );
  ...
  public function getFrequentFoods()
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/foods/log/frequent." . $this->responseFormat,
        null,
        OAUTH_HTTP_METHOD_GET,
        $headers
      );
  ...
  public function getFavoriteFoods()
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/foods/log/favorite." . $this->responseFormat,
        null,
        OAUTH_HTTP_METHOD_GET,
        $headers
      );
  ...
  public function logFood(
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/foods/log." . $this->responseFormat,
        $parameters,
        OAUTH_HTTP_METHOD_POST,
        $headers
      );
  ...
  public function deleteFood($id)
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/foods/log/" . $id . ".xml",
        null,
        OAUTH_HTTP_METHOD_DELETE,
        $headers
      );
  ...
  public function addFavoriteFood($id)
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/foods/log/favorite/" . $id . "." . $this->responseFormat,
        null,
        OAUTH_HTTP_METHOD_POST,
        $headers
      );
  ...
  public function deleteFavoriteFood($id)
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/foods/log/favorite/" . $id . ".xml",
        null,
        OAUTH_HTTP_METHOD_DELETE,
        $headers
      );
  ...
  public function getMeals()
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/meals." . $this->responseFormat,
        null,
        OAUTH_HTTP_METHOD_GET,
        $headers
      );
  ...
  public function getFoodUnits()
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "foods/units." . $this->responseFormat,
        null,
        OAUTH_HTTP_METHOD_GET,
        $headers
      );
  ...
  public function searchFoods($query)
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "foods/search." . $this->responseFormat . "?query=" . rawurlencode($query),
        null,
        OAUTH_HTTP_METHOD_GET,
        $headers
      );
  ...
  public function getFood($id)
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "foods/" . $id . "." . $this->responseFormat,
        null,
        OAUTH_HTTP_METHOD_GET,
        $headers
      );
   ...
   * @param string $nutrition                    Array of nutritional values, see
   *                                             http://wiki.fitbit.com/display/API/API-Create-Food
   *
   * @return mixed SimpleXMLElement or the value encoded in json as an object
   */
  public function createFood(
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "foods." . $this->responseFormat,
        $parameters,
        OAUTH_HTTP_METHOD_POST,
        $headers
      );
  ...
  public function getWater($date, $dateStr = null)
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/foods/log/water/date/" . $dateStr . "." . $this->responseFormat,
        null,
        OAUTH_HTTP_METHOD_GET,
        $headers
      );
  ...
  public function logWater($date, $amount, $waterUnit = null)
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/foods/log/water." . $this->responseFormat,
        $parameters,
        OAUTH_HTTP_METHOD_POST,
        $headers
      );
  ...
  public function deleteWater($id)
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/foods/log/water/" . $id . ".xml",
        null,
        OAUTH_HTTP_METHOD_DELETE,
        $headers
      );
  ...
  public function getSleep($date, $dateStr = null)
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/" . $this->userId . "/sleep/date/" . $dateStr . "." . $this->responseFormat,
        null,
        OAUTH_HTTP_METHOD_GET,
        $headers
      );
  ...
  public function logSleep($date, $duration)
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/sleep." . $this->responseFormat,
        $parameters,
        OAUTH_HTTP_METHOD_POST,
        $headers
      );
  ...
  public function deleteSleep($id)
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/sleep/" . $id . ".xml",
        null,
        OAUTH_HTTP_METHOD_DELETE,
        $headers
      );
  ...
  public function getBody($date, $dateStr = null)
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/" . $this->userId . "/body/date/" . $dateStr . "." . $this->responseFormat,
        null,
        OAUTH_HTTP_METHOD_GET,
        $headers
      );
   ...
   * @throws FitBitException
   *
   * @param string   $weight  Float number. For en_GB units, provide floating number of stones (i.e. 11 st. 4 lbs =
   *                          11.2857143)
  ...
  public function logBody(
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/body." . $this->responseFormat,
        $parameters,
        OAUTH_HTTP_METHOD_POST,
        $headers
      );
   ...
   * @param string   $weight Float number. For en_GB units, provide floating number of stones (i.e. 11 st. 4 lbs =
   *                         11.2857143)
   * @param DateTime $date   If present, log entry date, now by default (set proper timezone, which could be fetched
   *                         via getProfile)
   *
   * @return bool
   */
  public function logWeight($weight, $date = null)
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/body/weight." . $this->responseFormat,
        $parameters,
        OAUTH_HTTP_METHOD_POST,
        $headers
      );
  ...
  public function getBloodPressure($date, $dateStr)
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/bp/date/" . $dateStr . "." . $this->responseFormat,
        null,
        OAUTH_HTTP_METHOD_GET,
        $headers
      );
  ...
  public function logBloodPressure($date, $systolic, $diastolic, $time = null)
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/bp." . $this->responseFormat,
        $parameters,
        OAUTH_HTTP_METHOD_POST,
        $headers
      );
  ...
  public function deleteBloodPressure($id)
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/bp/" . $id . ".xml",
        null,
        OAUTH_HTTP_METHOD_DELETE,
        $headers
      );
  ...
  public function getGlucose($date, $dateStr)
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/glucose/date/" . $dateStr . "." . $this->responseFormat,
        null,
        OAUTH_HTTP_METHOD_GET,
        $headers
      );
  ...
  public function logGlucose($date, $tracker, $glucose, $hba1c = null, $time = null)
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/glucose." . $this->responseFormat,
        $parameters,
        OAUTH_HTTP_METHOD_POST,
        $headers
      );
  ...
  public function getHeartRate($date, $dateStr = null)
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/heart/date/" . $dateStr . "." . $this->responseFormat,
        null,
        OAUTH_HTTP_METHOD_GET,
        $headers
      );
  ...
  public function logHeartRate($date, $tracker, $heartRate, $time = null)
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/heart." . $this->responseFormat,
        $parameters,
        OAUTH_HTTP_METHOD_POST,
        $headers
      );
  ...
  public function deleteHeartRate($id)
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/heart/" . $id . ".xml",
        null,
        OAUTH_HTTP_METHOD_DELETE,
        $headers
      );
  ...
  public function getTimeSeries($type, $basedate, $to_period)
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/" . $this->userId . $path . '/date/' . (is_string(
          $basedate
        ) ? $basedate : $basedate->format('Y-m-d')) . "/" . (is_string(
          $to_period
        ) ? $to_period : $to_period->format('Y-m-d')) . ".json",
        null,
        OAUTH_HTTP_METHOD_GET,
        $headers
      );
  ...
  public function getIntradayTimeSeries($type, $date, $start_time = null, $end_time = null)
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-" . $path . "/date/" . (is_string($date) ? $date : $date->format(
          'Y-m-d'
        )) . "/1d" . ((!empty($start_time) && !empty($end_time)) ? "/time/" . $start_time->format(
            'H:i'
          ) . "/" . $end_time->format('H:i') : "") . ".json",
        null,
        OAUTH_HTTP_METHOD_GET,
        $headers
      );
  ...
  /**
   * Get user's activity statistics (lifetime statistics from the tracker device and total numbers including the
  ...
  public function getActivityStats()
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/" . $this->userId . "/activities." . $this->responseFormat,
        null,
        OAUTH_HTTP_METHOD_GET,
        $headers
      );
  ...
  public function getBadges()
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/" . $this->userId . "/badges." . $this->responseFormat,
        null,
        OAUTH_HTTP_METHOD_GET,
        $headers
      );
  ...
  public function getDevices()
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/devices." . $this->responseFormat,
        null,
        OAUTH_HTTP_METHOD_GET,
        $headers
      );
  ...
  public function getFriends()
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/" . $this->userId . "/friends." . $this->responseFormat,
        null,
        OAUTH_HTTP_METHOD_GET,
        $headers
      );
  ...
  public function getFriendsLeaderboard($period = '7d')
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/friends/leaders/" . $period . "." . $this->responseFormat,
        null,
        OAUTH_HTTP_METHOD_GET,
        $headers
      );
  ...
  public function inviteFriend($userId = null, $email = null)
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/friends/invitations." . $this->responseFormat,
        $parameters,
        OAUTH_HTTP_METHOD_POST,
        $headers
      );
  ...
  public function acceptFriend($userId)
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/friends/invitations/" . $userId . "." . $this->responseFormat,
        $parameters,
        OAUTH_HTTP_METHOD_POST,
        $headers
      );
   ...
   * @param null $path    Subscription resource path (beginning with slash). Omit to subscribe to all user updates.
  ...
  public function addSubscription($id, $path = null, $subscriberId = null)
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-" . $path . "/apiSubscriptions/" . $id . "." . $this->responseFormat,
        null,
        OAUTH_HTTP_METHOD_POST,
        $headers
      );
  ...
  public function deleteSubscription($id, $path = null)
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-" . $path . "/apiSubscriptions/" . $id . ".xml",
        null,
        OAUTH_HTTP_METHOD_DELETE,
        $headers
      );
  ...
  public function getSubscriptions()
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "user/-/apiSubscriptions." . $this->responseFormat,
        null,
        OAUTH_HTTP_METHOD_GET,
        $headers
      );
  ...
  public function getRateLimit()
  {
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "account/clientAndViewerRateLimitStatus.xml",
        null,
        OAUTH_HTTP_METHOD_GET,
        $headers
      );
    ...
    try {
      $this->oauth->fetch(
        $this->baseApiUrl . "account/clientRateLimitStatus.xml",
        null,
        OAUTH_HTTP_METHOD_GET,
        $headers
      );
   ...
   * @param string $method      (OAUTH_HTTP_METHOD_GET, OAUTH_HTTP_METHOD_POST, OAUTH_HTTP_METHOD_PUT,
   *                            OAUTH_HTTP_METHOD_DELETE)
...
class FitBitRateLimiting
{
   ...
   * @param      $viewer
   * @param      $client
   * @param null $viewerReset
   * @param null $clientReset
   * @param null $viewerQuota
   * @param null $clientQuota
   */
  public function __construct(
    $viewer,
    $client,
